      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              <span className="bg-primary h-8 w-8 rounded-md flex items-center justify-center mr-2 text-white font-bold">AD</span>
              <span className="text-xl font-bold">Abhijit Dengale</span>
            </div>
            <p className="mt-2 text-muted-foreground max-w-md">
              AI Agent Developer & Full-Stack Developer specializing in intelligent systems that learn, adapt, and grow.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-dark-700 flex flex-col md:flex-row justify-between items-center">
          <div className="text-muted-foreground text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Abhijit Dengale. All rights reserved.
          </div>
          
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/in/abhijitdengale" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-white transition-colors" aria-label="LinkedIn">
